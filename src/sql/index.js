module.exports = {
  // INSERT
  insertFunding:
    'INSERT INTO ceus_funding (title, description, joiner_interest, link, funding_money, time)  VALUES (?, ?, ?, ?, ?, ?)',
  insertVoting: 'INSERT INTO ceus_voting (title, description, link, time)  VALUES (?, ?, ?,?)',
  insertTask: 'INSERT INTO ceus_task (title, description, link, time)  VALUES (?, ?, ?, ?)',
